...
export default function Sidebar({ isOpen, onToggle, onLogout }) {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 h-screen bg-primary-900 border-r border-primary-700 z-50 hidden lg:flex flex-col"
    >
      {/* Logo */}
          ...
          >
            ...
            {item.badge && unreadCount > 0 && (
              <motion.span
                ...
                className="ml-auto bg-danger text-white text-xs px-2 py-0.5 rounded-full"
              >
                {unreadCount}
              </motion.span>
            )}
